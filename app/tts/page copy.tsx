      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {/* Speaker Selection */}
              {selectedModel && selectedModel.available_speakers?.length > 0 && (
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={
                    !selectedModel || !coerceToString(text).trim() || isLoading || connectionStatus !== "connected"
                  }
        ...
        {audioUrl && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {selectedModel && selectedModel.available_speakers?.length > 0 && speaker !== "" && (
              <OriginalAudioPlayer
                speaker={speaker}
            ...
            {/* Generated audio */}
            <Card className={speaker ? "" : "lg:col-span-2"}>
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    a.href = audioUrl
                    a.download = `tts_${selectedModel?.model_id || "model"}_${Date.now()}.wav`
